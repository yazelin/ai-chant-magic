...
export const SKILL_INFO: Record<SpellId, SkillInfo> = {
  ...
  aegis:     { name: '聖盾',            effect: '全隊護盾(永恆閃耀)',               stats: `持續 ${CONFIG.aegis.duration}s · 範圍 ${CONFIG.aegis.radius} · 冷卻 ${SPELLS.aegis.cooldown}s`, detail: '揮舞聖旗,為範圍內所有隊友(含自己)張開聖盾。貞德的團隊保命寶具,危急時的最後防線。' },
