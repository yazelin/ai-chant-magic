...
export const SKILL_INFO: Record<SpellId, SkillInfo> = {
  ...
  chant1:    { name: '黑暗詠唱',        effect: '蓄力,+1 爆裂充能',       stats: `+${CONFIG.chant.chargePerCast} 充能 · 無冷卻`, detail: '惠惠的中二詠唱(其一):無冷卻,可一直唱,每次 +1 爆裂充能,本身不造成傷害。充能愈高,之後的爆裂魔法愈強。' },
  chant2:    { name: '深淵詠唱',        effect: '蓄力,+1 爆裂充能',       stats: `+${CONFIG.chant.chargePerCast} 充能 · 無冷卻`, detail: '惠惠的中二詠唱(其二):無冷卻,可一直唱,每次 +1 爆裂充能。跟黑暗詠唱一起無限疊,堆愈多爆裂愈猛。' },
