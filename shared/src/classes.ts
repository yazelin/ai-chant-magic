...
export const CLASSES: Record<ClassId, ClassDef> = {
  ...
  cryo:   { id: 'cryo',   displayName: '霜法師', spells: ['frost', 'frostnova', 'mend'],      shape: 'hexagon',  color: '#39c5e0', hpMod: 1.0,  speedMod: 1.0 },
  storm:  { id: 'storm',  displayName: '雷術士', spells: ['thunder', 'chain', 'repulse'],     shape: 'triangle', color: '#b06cff', hpMod: 0.95, speedMod: 1.08 },
