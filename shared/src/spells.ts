...
export const SPELLS: Record<SpellId, SpellDef> = {
  ...
  frost:     { id: 'frost',     displayName: '冰柱魔線', aliases: ['冰柱魔線', '冰柱', '冰錐', '冰霜', '冰', 'frost', 'ice', '賓住', '並註', '冰住', '賓柱', '賓住無限', '冰柱無限'], cooldown: 1.5, kind: 'projectile', directional: true },
  ...
  aegis:     { id: 'aegis',     displayName: '聖盾',     aliases: ['聖盾', '永恆閃耀', '永恆閃耀聖盾', '神聖護盾', 'aegis', 'barrier'], cooldown: 9,   kind: 'buff-allies',  directional: false },
